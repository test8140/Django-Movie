    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('county', models.CharField(max_length=30, verbose_name='Country')),
                ...
                ('fees_in_world', models.PositiveIntegerField(default=0, help_text='indicate the amount in dollars', verbose_name='WORLD fees')),
                ('url', models.SlugField(max_length=160, unique=True)),
                ...
                ('cateory', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='movies.Category', verbose_name='Category')),
                ('directors', models.ManyToManyField(related_name='film_directors', to='movies.Actor', verbose_name='directors')),
